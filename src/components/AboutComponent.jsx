          ...
          <div className='py-10 w-full bg-gradient-to-b from-zinc-50 via-zinc-100 to-zinc-200 lg:w-1/2 lg:py-4'>
            <div className='h-full flex items-center'>
              <div className='text-center'>
                  ...
                  <p className='mx-auto pt-2 w-4/5 text-xl font-light leading-normal'>Kimberly Quirarte, the founder of Learning Time Adventures, director of the program & mother of 2 ultimately decided that she felt the need to impact her  community by starting her own home child care.</p>
