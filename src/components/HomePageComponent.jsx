          ...
          <main className='flex flex-col gap-6 justify-center items-center md:gap-16'>
            <section className='min-w-[100vw] flex justify-center bg-orange-100/95'>
              <div className='px-6 py-4 max-w-[1500px] flex flex-col justify-center gap-12 lg:flex-row lg:gap-20 lg:px-32 lg:py-20'>
                <div className='w-full lg:w-1/2 flex flex-col justify-center items-center lg:items-start'>
                  <h3 className='font-bold text-gray-700 text-2xl text-center sm:text-4xl lg:text-5xl lg:text-left'>Boosting Local Businesses With Custom Websites</h3>
                  ...
                  <Link to='/contact' className='px-2 py-1 mt-6 w-fit font-normal bg-gradient-to-r from-green-600 to-green-400 text-white hover:text-gray-300 shadow-md shadow-gray-700 rounded-3xl sm:px-4 sm:py-2 sm:text-xl md:text-2xl sm:mt-8' href="">Get In Touch</Link>
                </div>
            ...
            <section>
              <div className='flex flex-col items-center'>
                <h2 className='px-4 py-6 text-4xl text-center text-gray-700 leading-loose'>Stand <span className='py-5 px-2 text-white bg-gray-700 shadow-md shadow-gray-500 rounded-full'>Out</span><span className=''> From The Competition</span></h2>
