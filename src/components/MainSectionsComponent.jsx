    ...
    <>
        <main className='flex flex-col gap-16 justify-center'>
          ...
          <section className='flex flex-col gap-6 md:flex-row'>
            <div className='w-full bg-gradient-to-b from-yellow-200 via-yellow-200 to-yellow-300 md:w-1/2'>
          ...
          <section className='flex flex-col gap-6 md:flex-row'>
            <div className='w-full bg-gradient-to-b from-blue-50 via-blue-50 to-blue-200 md:w-1/2'>
