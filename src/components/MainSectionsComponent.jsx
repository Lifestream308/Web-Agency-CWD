          ...
          <main className='flex flex-col gap-6 justify-center md:gap-16'>
            <section className='relative w-full h-auto'>
              ...
              <div className='absolute w-full flex flex-col top-[14%] left-4 sm:left-6 md:top-[20%] md:left-8'>
                <h2 className='font-bold text-white text-xl sm:text-4xl md:text-4xl lg:text-5xl'>Safe. Reliable. Fun!</h2>
                <h2 className='text-white text-xl underline underline-offset-4 sm:text-4xl md:mt-4 md:text-4xl lg:text-5xl'>Learning Time Adventures</h2>
                <h2 className='font-extralight text-gray-300 text-sm sm:text-lg md:mt-2'>Licensed Daycare</h2>
                ...
                <Link to='/contact' className='px-2 py-1 mt-5 w-fit text-sm font-bold bg-gradient-to-r from-blue-700 to-blue-500 text-white hover:shadow-xl hover:text-gray-200 shadow-sm shadow-neutral-600 rounded-lg sm:px-4 sm:py-2 sm:text-xl sm:mt-8 md:mt-10 lg:mt-12' href="">Contact Us</Link>
              </div>
            </section>
