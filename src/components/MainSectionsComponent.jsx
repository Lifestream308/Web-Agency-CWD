          ...
          <main className='flex flex-col gap-6 justify-center md:gap-16'>
            ...
            <section className='relative w-full h-auto'>
              ...
              <div className='absolute w-full flex flex-col top-[14%] left-[7%] sm:left-6 md:top-[20%] md:left-8'>
                <h3 className='font-bold text-white text-3xl sm:text-5xl md:text-6xl lg:text-7xl'>Safe.</h3>
                <h3 className='font-bold text-white text-3xl sm:text-5xl md:text-6xl lg:text-7xl'>Reliable.</h3>
                <h3 className='font-bold text-white text-3xl sm:text-5xl md:text-6xl lg:text-7xl'>Fun!</h3>
